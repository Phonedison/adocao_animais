...
public class EnderecoController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "Nenhum endereço encontrado para o bairro informado")
    })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Busca realizada com sucesso"),
            @ApiResponse(responseCode = "404", description = "Nenhum endereço encontrado com este número")
    })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Busca realizada com sucesso"),
            @ApiResponse(responseCode = "404", description = "Nenhum endereço encontrado para a cidade informada")
    })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Busca realizada com sucesso"),
            @ApiResponse(responseCode = "404", description = "Nenhum endereço encontrado para a rua informada")
    })
    @GetMapping("/rua/{rua}")
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Busca realizada com sucesso"),
            @ApiResponse(responseCode = "404", description = "Nenhum endereço encontrado para o estado informado")
    })
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "409", description = "Conflito nos dados (ex: endereço idêntico já cadastrado)")
    })
    @PostMapping
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "Endereço não encontrado"),
            @ApiResponse(responseCode = "409", description = "Conflito ao atualizar os dados do endereço")
    })
    @PutMapping("/{id}")
