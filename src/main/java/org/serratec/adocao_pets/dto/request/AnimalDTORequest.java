...
public record AnimalDTORequest(
        ...
        @NotNull(message = "O campo não pode estar nulo") @Size(min = 10, max = 100, message = "Campo com permissão de 10 a 100 caracteres") String descricao,
        ...
        @NotNull(message = "O campo caracteristica deve ser informado com um dos Ids informado!") List<Long> caracteristicas) {
